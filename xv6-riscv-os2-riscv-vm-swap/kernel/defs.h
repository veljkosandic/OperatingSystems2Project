...
void            kfree(void *);
void            kinit(void);
void            setBit(void*,char,char);
void*           getFree();
void            setToKernPage(void*);
char            isCandidate(unsigned long);
unsigned long   getTotal();
unsigned long   getFirst();
void            putPTEAddr(void*,pte_t*);
pte_t*          getPTEAddr(void*);
...
void             swap_init();
unsigned long    getVictim(pte_t**);
void             free_from_disk(unsigned long);
void             start_swapping();
void             end_swapping();
void             update_refs();
void             clear_ref(unsigned long);
unsigned long    get_ref(unsigned long);
void             update_table(unsigned long);
